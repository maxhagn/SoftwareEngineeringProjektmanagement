...
public class CancellationInvoicePdfCreator {
    ...
    public static void createPdf(String outputPath, Ticket ticket) throws Exception {
       ...
       String createdDate = ticket.getCreateDate().format(format);
       ...
       replacedHtml = replacedHtml.replace("%invoiceNr%", ticket.getId().toString());
        replacedHtml = replacedHtml.replace("%createInvoice%", createdDate);
   ...
   private static String html = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" +
       ...
       "        Rechnungsdatum: %createInvoice%<br/>\n" +
       "        Liefer- bzw. Leistungsdatum: %performanceDate%<br/>\n" +
       "        Korrekturdatum: %nowDate%<br/>\n" +
       "        Ust-IdNr.: 12345678<br/>\n" +
       "    </div>\n" +
       "    <div>\n" +
       "        <br/>\n" +
       "        <h3>Zu Rechnungs Nr.: %invoiceNr%</h3>\n" +
       "        <br/>\n" +
       "        <p>Sehr Geehrte Damen und Herren</p>\n" +
       "        <br/>\n" +
       "        <p>\n" +
       "            Gemäß unserer Absprache schreiben wir Ihnen folgenden Betrag aus \n" +
       "Rechnung-Nr. %invoiceNr% vom %createInvoice% gut:\n" +
       "        </p>\n" +
       "        <br/>\n" +
       "        <table class=\"items\">\n" +
       "            <thead>\n" +
       ...
       "        </table>\n" +
       "\n" +
       "<p>Der ausstehende Betrag wird Ihnen auf der ursprünglichen Zahlunsmethode gut geschrieben. </p>\n" +
       "    </div>\n" +
       "    <div class=\"footer\">\n" +
       "        <table>\n" +
       "            <thead>\n" +
